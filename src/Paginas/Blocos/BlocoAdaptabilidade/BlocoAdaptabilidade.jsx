...
import Ilha from '../Componentes/assets/imagens/ADAPTABILIDADE-BLOCO.png';
import './BlocoAdaptabilidade.css';
import { useNavigate } from 'react-router-dom';
import Cena from '../Componentes/Cena/Cena';

function BlocoAdaptabilidade() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(`${API_URL}/adaptacao-cenas`, {
          method: 'GET',
          headers: {
  ...
  return (
    <div>
      ...
      <div className={`${completedScenes ? 'mapa-Sensorial-container' : 'mapa-Sensorial-desfocado'} BlocoAdaptabilidade`}>
      <button className="voltar-button" onClick={() => navigate("/trilha")}>
            ...
            <div className='BlocoFundo'>
                <div className='IlhaImagem'>
                    ...
                    <div className='Bolinhas'>
                        <div className='Bolinha1' onClick={() => navigate("/trilha/Adaptabilidade/atividade=1")}>1</div>
            ...
            <div className='infoilha'>
                ...
                <p>Trabalhe sua flexibilidade e adaptação.</p>
            </div>
      </div>
    </div>
  );
...
export default BlocoAdaptabilidade;
